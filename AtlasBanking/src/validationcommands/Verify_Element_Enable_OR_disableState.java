...
public class Verify_Element_Enable_OR_disableState 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//Write condition to verify Elemnet disabled
		...
		if(Locality_Editbox.isEnabled())
			System.out.println("Testpass editbox enabled after city and state selection");
		else
			System.out.println("Testfail editbox disabled after city and state selection ");
	}
