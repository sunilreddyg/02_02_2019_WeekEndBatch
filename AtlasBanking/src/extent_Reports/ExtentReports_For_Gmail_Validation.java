...
public class ExtentReports_For_Gmail_Validation {
	...
	public static void main(String[] args) throws Exception {
		...
		String filepath="D:\\02_02_2019\\gmail.html";
		...
		String path="D:\\02_02_2019\\gmail_login.png";
		...
		{
			test.log(LogStatus.PASS, "As expected "
					+ "Password visible on valid email entry"+test.addScreenCapture(path));
